    ...
    <div className="text-white bg-[#121212]">
      ...
      <section className="w-full flex justify-center">
        <div className="max-w-screen-2xl w-full flex flex-col gap-10 items-center mt-32">
          ...
          <div class="collapse" id="collapseExample">
            <div class="flex flex-col max-w-screen-lg text-xl p-6 rounded-lg bg-[#1f1f1f]">
              <div className="w-full border-2 border-[#383838] bg-[#212121c9] py-5 rounded-xl flex justify-center mb-2 mt-5">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                ...
                <div className="border-2 border-[#191919] flex flex-col max-w-xs w-full bg-[#343434c9] rounded-xl px-6 py-5">
                  <div className="flex gap-2">
                    ...
                    <h3 className="font-bold">Project Menagement</h3>
                  </div>

                  <ul className="mt-7 ">
                    <li>- Kanban</li>
                    <li>- Wireframes</li>
                    <li>- Burn Up / Down Charts</li>
                    <li>- CI / CD Pipelines</li>
                    <li>- wasddasd da</li>
                    <li>- dsa dasdw</li>
                    <li>- wasdddad dwddd</li>
                    <li>- dwasd wd</li>
                    <li>- wwwdasd wasd d332d</li>
                  </ul>
                </div>
                ...
                <section className="w-full border-t-2 border-gray-400 mt-10">
                  <ul>
                    <li></li>
                  </ul>
                </section>
      ...
      <section className="w-full flex justify-center">
        <div className="max-w-screen-4xl w-full flex flex-col items-center mt-32">
          <h2 className="text-5xl font-bold mb-10">Project I've Done</h2>
      ...
      <footer className="w-full flex justify-center mt-20 py-10">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-2xl font-bold">This is a footer</h3>
          <p className="text-lg mt-3 max-w-xl text-center">
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi
            deleniti cum nesciunt suscipit"
          </p>
          ...
          <span className="font-thin italic mt-4">
            contact me at: joaosantosdev99@gmail.com
          </span>
        </div>
      </footer>
    </div>
